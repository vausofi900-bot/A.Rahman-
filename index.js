...
const BOT_NAME = pkg.name || "SaGor bot";
const BOT_VERSION = pkg.version || "5.0.0";
const BOT_DESC = pkg.description || "SaGor Bot";
...
axios.get("https://raw.githubusercontent.com/SAGOR-KINGx/Mirai-bot/main/package.json")
    .then((res) => {
