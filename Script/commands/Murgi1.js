...
module.exports.run = async function({ api, args, Users, event}) {
    ...
    if(!mention) return api.sendMessage("আমার বস প্রিন্স রে যেই খানকির পোলা গালি দিছে কইরে তুই 🤬😈", event.threadID);
 let name =  event.mentions[mention];
    var arraytag = [];
        arraytag.push({id: mention, tag: name});
    var a = function (a) { api.sendMessage(a, event.threadID); }
a("আমি প্রিন্স করলাম শুরু তর আম্মুর ভুদায় দিব হাত");
setTimeout(() => {a({body: "খাংকির পোলা তর মারে চুদে প্রিন্স 🥰।" + " " + name, mentions: arraytag})}, 3000);
setTimeout(() => {a({body: "খাংকির পোলা তর কচি বোন রে চুদি 😍.." + " " + name, mentions: arraytag})}, 5000);
setTimeout(() => {a({body: "মাদারচোদ তর আম্মু পম পম খাংকির পোলা তোর আব্বুর নাম প্রিন্স 🐰" + " " + name, mentions: arraytag})}, 7000);
...
setTimeout(() => {a({body: "Hi প্রিন্স এর জারজ মাগির পোলা  💔!" + " " + name, mentions: arraytag})}, 114000);
...
setTimeout(() => {a({body: "Hi প্রিন্স এর জারজ পোলা মাগির পোলা  💔!" + " " + name, mentions: arraytag})}, 9000);
setTimeout(() => {a({body: "খান্কি মাগির পোলা " + " " + name, mentions: arraytag})}, 12000);
setTimeout(() => {a({body: "তোর মারে তোর কান্দে ফালায় চোদবো। 🤬 " + " " + name, mentions: arraytag})}, 15000);
...
setTimeout(() => {a({body: "তর বোন ভোদা ছিল্লা লবণ লাগায় দিমু। " + " " + name, mentions: arraytag})}, 36000);
setTimeout(() => {a("~ প্রিন্স এর পুত। জা ভাগ🤖")} , 39000);
