...
var one = senderID, two = id;
    return makeImage({ one, two }).then(path => api.sendMessage({ body: `🌺${namee}🌺 YOUR COUPLE IS MADE 🌺${name}🌺Now don’t keep saying “get us matched again”! 😒👈 『$le}』`, mentions: arraytag, attachment: fs.createReadStream(path) }, threadID, () => fs.unlinkSync(path), messageID));
}
